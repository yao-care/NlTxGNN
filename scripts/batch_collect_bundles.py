...
import pandas as pd
from nltxgnn.collectors import DrugBundleAggregator
from nltxgnn.paths import get_bundles_dir, slugify
...
def preload_predictions(min_score: float = 0.99, top_n: int = 10) -> dict[str, list]:
    ...
    """
    from nltxgnn.collectors.drug_bundle import PredictedIndication
    from nltxgnn.collectors.known_relations import KnownRelationsChecker
...
def patch_single_drug(
    ...
    """
    from nltxgnn.collectors.drug_bundle import DrugBundle
