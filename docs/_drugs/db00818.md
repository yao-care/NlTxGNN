...
| Bewijsniveau | L5 (Computationele Voorspelling) |
| Aantal Voorspelde Indicaties | 100 |

## Voorspelde Indicaties (TxGNN)

De volgende zijn potentiële nieuwe indicaties voorspeld door het TxGNN-model. Hogere scores duiden op een hogere voorspelde relevantie.
...
Deze voorspellingen zijn uitsluitend voor onderzoeksdoeleinden en vormen geen medisch advies.
Klinische validatie is vereist vóór elke klinische toepassing.

---

[← Terug naar Geneesmiddelenzoekfunctie](/drugs/)
